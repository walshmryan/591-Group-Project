...
//        gameListener = (PlayGameListener) context;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTurnTextView = ((TextView) v.findViewById(R.id.turn_counter_view));
...
//                gameListener.btnBlackClicked();
    ...
    public void onConnectionFailed(ConnectionResult connectionResult) {
        ...
        if (mSignInClicked || mAutoStartSignInFlow) {
            ...
            mResolvingConnectionFailure = BaseGameUtils.resolveConnectionFailure(this.getActivity(),
    ...
    public void setViewVisibility() {
        ...
        if (!isSignedIn) {
            this.getView().findViewById(R.id.login_layout).setVisibility(View.VISIBLE);
            this.getView().findViewById(R.id.sign_in_button).setVisibility(View.VISIBLE);
            this.getView().findViewById(R.id.matchup_layout).setVisibility(View.GONE);
            this.getView().findViewById(R.id.gameplay_layout).setVisibility(View.GONE);
        ...
        ((TextView) this.getView().findViewById(R.id.name_field)).setText(Games.Players.getCurrentPlayer(
                mGoogleApiClient).getDisplayName());
        this.getView().findViewById(R.id.login_layout).setVisibility(View.GONE);

        if (isDoingTurn) {
            this.getView().findViewById(R.id.matchup_layout).setVisibility(View.GONE);
            this.getView().findViewById(R.id.gameplay_layout).setVisibility(View.VISIBLE);
        } else {
            this.getView().findViewById(R.id.matchup_layout).setVisibility(View.VISIBLE);
            this.getView().findViewById(R.id.gameplay_layout).setVisibility(View.GONE);
        }
    }
    ...
    public void showSpinner() {
        this.getView().findViewById(R.id.progressLayout).setVisibility(View.VISIBLE);
    }

    public void dismissSpinner() {
        this.getView().findViewById(R.id.progressLayout).setVisibility(View.GONE);
    }
    ...
    public void onActivityResult(int request, int response, Intent data) {
        ...
        if (request == RC_SIGN_IN) {
            ...
            if (response == Activity.RESULT_OK) {
                ...
                BaseGameUtils.showActivityResultError(this.getActivity(), request, response, R.string.signin_other_error);
            }
...
//        this.startActivityForResult(intent, RC_LOOK_AT_MATCHES);
